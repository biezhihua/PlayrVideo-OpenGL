...
public class TextureViewMediaActivity extends Activity implements TextureView.SurfaceTextureListener,
    ...
    public static final String videoPath = Environment.getExternalStorageDirectory().getPath()+"/Download/one.mp4";
...
//            mediaPlayer.setDataSource(Environment.getExternalStorageDirectory().getPath() + "/Download/one.mp4");
			mediaPlayer.setDataSource(Environment.getExternalStorageDirectory().getPath() + "/Download/AceBanna.4K.mp4");
//			mediaPlayer.setDataSource(Environment.getExternalStorageDirectory().getPath() + "/Download/one_1.avi");
//			mediaPlayer.setDataSource(Environment.getExternalStorageDirectory().getPath() + "/Download/WatchCS.mp4");
//			mediaPlayer.setDataSource(Environment.getExternalStorageDirectory().getPath() + "/Download/3602.mp4");
//            mediaPlayer.setDataSource(Environment.getExternalStorageDirectory().getPath() + "/Download/one1.mp4");
//			mediaPlayer.setDataSource(Environment.getExternalStorageDirectory().getPath() + "/Download/StreamVR.avi");
